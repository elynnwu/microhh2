...
# ucla = Dataset('/mnt/lab_48tb1/database/Sc_group/uclales_output/dycoms_rf01/radtype2/rf01_merged.ps.nc')
ucla = Dataset('/Users/elynn/Downloads/rf01_merged.ps.nc')
...
# set the height
z     = ucla['zm'][:]# numpy.linspace(0.5*dz, zsize-0.5*dz, kmax)
